...
from invenio_administration.views.base import AdminResourceListView, AdminResourceEditView, AdminResourceCreateView
...
class JobsFormMixin:
    ...
    def form_fields(self):
        jobs_queues = [{"title_l10n": str(queue["title"]), "id": queue["name"]} for queue in JOBS_QUEUES.values()]
